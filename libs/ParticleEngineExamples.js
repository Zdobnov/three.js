...
Examples =
{
	...
	{
		positionStyle    : Type.CUBE,
		positionBase     : new THREE.Vector3( 0, 0, 0 ), //position
		positionSpread   : new THREE.Vector3( 0.1, 0, 0.1 ), //spread square

		velocityStyle    : Type.CUBE,
		velocityBase     : new THREE.Vector3( 0, 10, 0 ),
		velocitySpread   : new THREE.Vector3( 0.5, 10, 0.5 ), 
		...
		sizeTween    : new Tween( [0, 0.1], [32, 32] ),
